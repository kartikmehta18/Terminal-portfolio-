...
import { SiNetlify, SiReact, SiTailwindcss, SiVercel } from "react-icons/si";
...
export default function About() {
	...
	return (
		<div>
			<h1 className="text-2xl text-yellow-200 animate-reveal-0.5">What is terminal portfolio?</h1>
			<p className="text-lg mb-3 animate-reveal-0.5">
				Terminal Portfolio is a portfolio designed in a terminal way to showcase a developer's appreciation towards command-line tools.
			</p>
