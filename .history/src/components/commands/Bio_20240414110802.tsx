...
export default function Bio() {
	...
	return (
		<div className="mt-2 mb-2 w-11/12 mx-auto">
			...
			<p>
				Hi there, I am a Front-end developer and I like to learn new things related to coding and sharing it.
				Other than coding, I also love doing some Web & Graphic Designing, and some beatboxing when it's showtime!
			</p>
